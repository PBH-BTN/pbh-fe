<template>
    <a-space direction="vertical">
        ...
        <a-form ref="formRef" :model="config.downloaderConfig" auto-label-width>
            <a-form-item field="downloaderConfig.type" :label="t('page.dashboard.editModal.label.type')" required>
                <a-radio-group v-model="config.downloaderConfig.downloaderConfig.type">
                ...
                <template #extra v-if="config.downloaderConfig.downloaderConfig.type === ClientTypeEnum.BiglyBT">
            ...
            <component :is="formMap[config.downloaderConfig.downloaderConfig.type] as any"
